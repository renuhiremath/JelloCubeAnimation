  ...
  else
  {
      ...
      // 1 = bottom, 2 = front, 3 = left, 4 = right, 5 = far, 6 = top
    {
      ...
      for (i=0; i <= 6; i++)
        ...
        glBindTexture( GL_TEXTURE_2D, jello->textureId[face-1] );
        ...
        //     glFrontFace(GL_CW); // flip definition of orientation
          ...
          switch (face)
          {
            case 1:
              glTexCoord2f(0,0);
              glVertex3f(jello->p[0][7][0].x, jello->p[0][7][0].y, jello->p[0][7][0].z);
              glTexCoord2f(1,0);
              glVertex3f(jello->p[7][7][0].x, jello->p[7][7][0].y, jello->p[7][7][0].z);
              glTexCoord2f(1,1);
              glVertex3f(jello->p[7][0][0].x, jello->p[7][0][0].y, jello->p[7][0][0].z);
              glTexCoord2f(0,1);
              glVertex3f(jello->p[0][0][0].x, jello->p[0][0][0].y, jello->p[0][0][0].z);
              break;
            ...
            case 2:
              ...
              glVertex3f(jello->p[7][0][0].x, jello->p[7][0][0].y, jello->p[7][0][0].z);
              glTexCoord2f(1,1);
              glVertex3f(jello->p[7][0][7].x, jello->p[7][0][7].y, jello->p[7][0][7].z);
              glTexCoord2f(0,1);
              glVertex3f(jello->p[0][0][7].x, jello->p[0][0][7].y, jello->p[0][0][7].z);
              break;
            ...
            case 3:
              ...
              glVertex3f(jello->p[0][0][7].x, jello->p[0][0][7].y, jello->p[0][0][7].z);
              glTexCoord2f(0,1);
              glVertex3f(jello->p[0][7][7].x, jello->p[0][7][7].y, jello->p[0][7][7].z);
              break;
            ...
            case 4:
              ...
              glVertex3f(jello->p[7][7][0].x, jello->p[7][7][0].y, jello->p[7][7][0].z);
              glTexCoord2f(1,1);
              glVertex3f(jello->p[7][7][7].x, jello->p[7][7][7].y, jello->p[7][7][7].z);
              glTexCoord2f(0,1);
              glVertex3f(jello->p[7][0][7].x, jello->p[7][0][7].y, jello->p[7][0][7].z);
              break;
...
bool findInteractionWithPlane(struct world * jello, point p)
{
  if ((jello->a*p.x + jello->b*p.y + jello->c*p.z + jello->d) == 0)
    return true;
  else
    return false;
}
...
void showPlane(struct world * jello)
{
  ...
  point intersection_points[4];

  //find interaction points with the bounding box
  point p;
  ...
  // glDisable(GL_CULL_FACE);
	// glBegin(GL_POLYGON);
	// for (int i = 0; i < intersection_points_count; i++){
	// 	glVertex3f(intersection_points_count[i].x, intersection_points_count[i].y, intersection_points_count[i].z);
	// }
	// glEnd();
